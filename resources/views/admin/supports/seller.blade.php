...
@section('content')
    <div class="container-fluid py-3">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h4><i class="bi bi-shop-window me-2 text-primary"></i> Seller Tickets</h4>
        </div>
        ...
        <div class="support-wrapper">
            ...
            <div class="ticket-list">
                ...
                @empty
                    <div class="alert alert-light text-center">No seller tickets found.</div>
                @endforelse
...
@push('scripts')
    ...
    <script>
        // EXACT SAME JS, except role = "admin"
        ...
        document.addEventListener("DOMContentLoaded", () => {
            ...
            function loadChat(id) {
                fetch(`/admin/support/tickets/${id}?ajax=1`)
                    ...
                    .then(data => {
                        chatBody.innerHTML = "";
                        chatTitle.textContent = `${data.subject} — ${data.customer || data.seller}`;
