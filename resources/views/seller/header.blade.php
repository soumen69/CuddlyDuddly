...
<div
    ...
    <div class="w-full flex flex-wrap gap-4">
        ...
        <div class="w-full lg:w-auto flex items-center gap-5">
            ...
            <span class="rounded-[50%] bg-[var(--color-pink-transparent)] group cursor-pointer hover:bg-black transition-all duration-300">
                <form id="logoutForm" method="POST" action="{{ route('seller.logout') }}"
                    class="w-9 h-9 md:w-12 md:h-12 ml-auto flex mr-0 my-0 md:m-auto group rounded-full border-0 hover:bg-black flex items-center justify-center">
                    @csrf
                    <button type="button" id="logoutBtn"
                        class="flex flex-col items-center justify-center cursor-pointer text-sm text-center text-white group-hover:text-white">
