                 ...
                 <div class="px-6 pt-7 space-y-7">
                     ...
                     <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                         ...
                         <div>
                             ...
                             <div class="relative">
                                 <select name="product_categories_id" id="productCategory" class="seller-info-field"
                                     required>
                         ...
                         <div>
                             <label class="form-label">
                                 ...
                                 <select name="product_sub_categories_id" id="productSubCategory" class="seller-info-field"
                                     required>
                     ...
                     <div>
                         ...
                         <textarea class="seller-info-field" name="description" rows="4"
                             placeholder="Brief description shown under product name with in 1000 characters" data-maxlength="1000">{{ old('description', $product->description ?? '') }}</textarea>
