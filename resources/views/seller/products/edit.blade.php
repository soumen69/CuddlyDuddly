...
@section('content')
    ...
    @push('scripts')
        ...
        @php
            $sellerExistingProductImages = $product->images
                ->map(function ($img) {
                    return [
                        'id' => $img->id,
                        'path' => $img->image_path,
            ...
            $sellerExistingAttributes = $product->attributeValues
                ->map(function ($value) {
                    return [
            ...
            $sellerExistingVariants = $product->variants
            ...
            $sellerExistingVisualImages = $product->visualImages
                ->map(function ($img) {
                    return [
                        'id' => $img->id,
